...
- 完整性检查：初始来源文件的 SHA-256 已记录。2026-08-20 按主办方最新决定取消常规赛现金奖金、更新两项季后赛奖金与预算；随后将网站维护与赛事组织目标调整为 500 元、众筹目标总额调整为 2800 元，并明确最终执行以实际众筹情况为准。2026-08-24 增加掉线扣分与周内禁赛规则；2026-09-01 将赛事工作积分调整为房主 +20、主播固定 +20、赛事统计员 +5，并规定同一比赛日兼职工作加分合计最高 30 分。仓库只保留正式公开方案，不再保留重复的参考副本。
...
- 管理用完整积分榜：`data-source/dsl2/full-standings.csv`，包含全部选手及管理统计字段。
