...
页面按铂金、钻石、黄金、白银分组，同档按名单中的顺序展示。没有赞助商的档位仍保留标题与分区，并显示“虚位以待，欢迎支持赞助”。等级与顺序由主办方确认，不按累计金额自动调整。当前两位铂金赞助商依次为 DR.Yang、WoShiLaoCaiNiao，钻石档位空缺；白银赞助商依次为 shougong、nianqing、KaKaRu。
